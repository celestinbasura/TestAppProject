...
public interface Modbus {
   ...
   * com.cele.testapp.modbus.debug=false|true (-D flag to the jvm).
   */
  public static final boolean debug = "true".equals(System.getProperty("com.cele.testapp.modbus.debug"));
